...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://spec-repo-1-ez1e.onrender.com/auth/login", {
        method: "POST",
      ...
      if (data.token) {
        // ✅ TO‘G‘RI KALIT BILAN TOKENNI SAQLAYMIZ
      ...
      alert(error.message || "Server bilan ulanishda xatolik yuz berdi");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="w-full h-screen flex">
      <div className="w-1/2 relative hidden md:block">
        <img
          src="https://images.woodenstreet.de/image/data%2FLooks%2F1.jpg"
          alt="decor"
